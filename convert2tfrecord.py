...
# Input - route, dataset list .txt: img_dir label
# Ouput: converted dataset .tfrecords
# Example: convert2tfrecord('./toy_data/', './list/list.txt', 128, 128, 'train.tfrecords')

def convert2tfrecord(route, list_data_set, img_w, img_h, save_name):
